...
s_sig_verify.add_material_rule_from_string("ALLOW terra/tfplan.binary")
s_sig_verify.add_material_rule_from_string("ALLOW terra/tfplan.binary.sigstore.json")
